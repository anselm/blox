...
class XRSupport {
	...
	constructor(args) {
		// bring in polyfill by hand only if needed because it wants to add stuff to the DOM even if not used
		let s = document.createElement( 'script' );
		let polyfill = "/lib/webxr-polyfill.js"
		s.setAttribute( 'src', src );
		s.onload = () => { this.construct.bind(args) }
	}
